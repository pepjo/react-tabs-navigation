...
module.exports = Radium(React.createClass({
  ...
  handleElementScroll: function () {
    let top = ReactDom.findDOMNode(this.props.tabsContainer).offsetTop - this.props.fixOffset
  ...
  render: function () {
    ...
    ? <div
      style={{
        height: ((styles.tabsBarStyle.height || defaultStyles.tabsBarStyle.height) || 0) +
        ((styles.tabsBarStyle.paddingTop || defaultStyles.tabsBarStyle.paddingTop) || 0) +
        ((styles.tabsBarStyle.marginTop || defaultStyles.tabsBarStyle.marginTop) || 0)
      }}
    />
    : null
